...
from extragere.pula import get_web_content, extract_injuraturi, save_to_db, is_url_processed
...
BLACKLISTED_DOMAINS = [
    "dexonline.ro", "dexonline.net", "dictionarroman.ro", "wiktionary.org", 
    "reverso.net", "dozadesanatate.ro", "sfatulmedicului.ro", "reginamaria.ro",
    "medlife.ro", "somaclinic.ro", "mdrl.ro", "carezone.ro", "dex.md",
    "wordreference.com", "cooljugator.com", "pluralul.ro", "dictionar.ro",
    "bab.la", "glosbe.com", "qdictionar.com", "archeus.ro", "plural.ro"
]
    ...
    for attempt in range(max_retries):
        ...
        try:
            ...
            if response.status_code == 403:
                print(f"  Warning: 403 Forbidden on attempt {attempt+1}. Cooldown triggering...")
                return "COOLDOWN"
            ...
            print(f"  Search error (Attempt {attempt+1}/{max_retries}): {e}. Retrying in {wait_time}s...")
